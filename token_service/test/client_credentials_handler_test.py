...
import token_service.main.client_credentials_handler as handler
...
class TestClientCredentialsHandler:
    def test_create_token_ok(self, mocker):
        ...
        response = handler.create_token(create_client_token_event, {})
    ...
    def test_refresh_token_ok(self, mocker):
        ...
        response = handler.refresh_token(refresh_client_token_http_event, {})
